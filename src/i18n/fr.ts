...
export const fr: I18nDictionary = {
  ...
  "bot.photo_vision_describing": "🔍 Description de la photo avec le modèle de vision local...",
  "bot.photo_vision_fallback_error": "🔴 Service de vision local indisponible (127.0.0.1:8082). Lancez-le avec ~/models/lfm2.5-vl-3b/start.sh",
  ...
  "cjk_guard.blocked_notice": "⚠️ Le modèle n'a pas réussi à répondre en espagnol. Veuillez renvoyer votre demande.",
  "cjk_guard.correcting_notice": "⚠️ Réponse dans un autre alphabet (CJK) détectée. Demande au modèle de la réécrire en espagnol…",
};
