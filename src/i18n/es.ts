...
export const es: I18nDictionary = {
  ...
  "bot.photo_vision_describing": "🔍 Describiendo la foto con el modelo de visión local...",
  "bot.photo_vision_fallback_error": "🔴 Servicio de visión local no disponible (127.0.0.1:8082). Arranca el modelo con ~/models/lfm2.5-vl-3b/start.sh",
  ...
  "cjk_guard.blocked_notice": "⚠️ El modelo no consiguió responder en español. Vuelve a enviar la petición.",
  "cjk_guard.correcting_notice": "⚠️ Respuesta en otro alfabeto (CJK) detectada. Pidiendo al modelo que la reescriba en español…",
};
